...
function RegulatoryBanner(){
  ...
  return (
    <div style={{background:"var(--ink)",color:"var(--cream)",padding:isMobile?"14px 20px 22px":"18px 48px",textAlign:"center",fontSize:isMobile?10:11,letterSpacing:".12em", lineHeight:1.5, position:"relative", zIndex:60}} className="uc mono">
